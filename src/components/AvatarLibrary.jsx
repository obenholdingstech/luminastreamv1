          ...
          {list.items.map((a) => (
            <li key={a.id} className="relative group">
              ...
              <button
                ...
                className="absolute -right-2 -top-2 rounded-full bg-[#0B0B14] p-1.5 text-[#3E4A5F] hover:text-[#FCA5A5] focus-visible:text-[#FCA5A5] group-hover:text-[#64748B] disabled:opacity-50"
              >
